<?php
    ...
    /**
     * Контроллер для работы с пользователями. Регистрация, авторизация, выход из учетной записи, а также просмотр, изменение и удаление данных о пользователях, доступные администраторам
     */
    class UserController extends BaseController
    {
        ...
        /**
         * Метод для регистрации новых пользователей. Выводит view с формой регистрации
         */
        ...
        /**
         * Метод для авторизации пользователей. Выводит view с формой авторизации
         */
